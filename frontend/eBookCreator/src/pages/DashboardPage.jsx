...
const DashboardPage = () => {
  ...
  const handleDeleteBook = async () => {
    ...
    setBooks(
      books.filter((book) => book._id !== bookToDelete)
    );
  ...
  <div className="flex flex-col items-center justify-center py-12 text-center border-2 border-dashed border-slate-200 rounded-xl mt-2">
