...
if (isLoading || !book) {
  ...
  return (
    ...
    {isSidebarOpen && (
      ...
      <div className="absolute top-0 right-0 -nr-12 pt-2">
        <button
          type="button"
          className="ml-1 flex items-center justify-center h-10 w-10 rounded-full focus:outline-none focus:ring-2 focus:ring-insert focus:ring-white"
          onClick={() => setIsSidebarOpen(false)}
        >
    ...
    <div className="flex items-center gap-2">
      ...
      <div className="hidden sm:flex space-x-1 bg-slate-100 p-1 rounded-lg">
        <button
          ...
          className={`flex items-center justify-center flex-1 py-2 px-4 text-sm font-medium ${
            activeTab === "editor"
        ...
        >
           ...
           <button 
           onClick={() => setActiveTab("details")}
            className={`flex items-center justify-center flex-1 py-2 px-4 text-sm font-medium rounded-medium transition-colors duration-200 whitespace-nowrap ${
            activeTab === "details"
              ? "bg-white text-slate-800 shadow-sm"
              : "text-slate-500 hover:text-slate-700"
          }`}
