...
const ProfileDropdown = ({
    ...
    <div className="relative">
      ...
      >
        {avatar ? (
          ...
          <div className="h-8 w-8 bg-gradient-to-br from-violet-500 rounded-xl flex items-center justify-center">
  ...
  <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-gray-100 py-2 z-50">
    ...
    <a
      href="#"
      onClick={onLogout}
      className="border-t px-4 py-2 text-sm text-red-600 hover:bg-red-50 transition-colors"
    >
      Sign out
    </a>
  </div>
