...
const Navbar = () => {
  ...
  return <header>
    ...
    <div className="flex items-center justify-between h-16">
      ...
      <div className="w-9 h-9 bg-gradient-to-br from-violet-400 to-purple-500 rounded-xl flex items-center justify-center shadow-lg shadow-violet-500/40 transition-all duration-300 group-hover:scale-110">
